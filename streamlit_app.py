...
# الكود الكامل مع معالجة الشعار والأقسام
full_code = """
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        /* تحسين الهوامش لتفادي التداخل */
        .main-container { padding: 130px 20px 50px 20px; display: flex; flex-direction: column; items: center; }
        
        /* تصميم الشعار المحدث */
        .logo-container { text-align: center; margin-bottom: 30px; }
        .logo-img { width: 140px; height: 140px; border-radius: 30px; box-shadow: 0 0 40px rgba(34, 211, 238, 0.3); border: 3px solid #22d3ee; margin: 0 auto; object-fit: cover; }
        .logo-text { font-size: 2.8rem; font-weight: 900; letter-spacing: 5px; margin-top: 15px; text-transform: uppercase; color: white; line-height: 1; }
...
<body>
    <div class="marquee-wrapper">
        <div class="animate-marquee">
            📢 Toro Libya: تم تفعيل نظام التحديث الفوري من غرف الواتساب .. ₿ البيتكوين $96,430 .. 💍 ذهب كسر 18 بـ 415.5 دينار .. 🏗️ الإسمنت 45.00 دينار .. 🐂
        </div>
    </div>
    ...
    <div class="main-container">
        <div class="logo-container">
            ...
            <img src="https://i.ibb.co/Lhb8m9P/toro-logo.png" onerror="this.src='https://ui-avatars.com/api/?name=Toro+Ly&background=0b1120&color=22d3ee&size=150'" class="logo-img" alt="Toro Ly">
        ...
        <div class="quick-grid">
            <div class="quick-card"><p>USD/LYD</p><span id="q-usd">8.65</span></div>
            <div class="quick-card"><p>GOLD 18</p><span id="q-gold">415.5</span></div>
            <div class="quick-card"><p>BTC/USD</p><span id="q-btc">96.4K</span></div>
        </div>

        <div class="w-full max-w-md">
            <div class="glass p-5 border-l-4 border-cyan-500">
                <h2 class="section-title">🌟 نبض السوق والتوصيات</h2>
                <p class="text-[11px] text-green-400 italic">✅ الشعار الجديد يعكس قوة البيانات المستلمة من غرف الواتساب الموثوقة.</p>
            ...
            <div class="glass border-2 border-cyan-500/30 p-6">
                <h3 class="text-center text-cyan-400 text-xs font-bold mb-4 uppercase">🔄 Currency Converter</h3>
